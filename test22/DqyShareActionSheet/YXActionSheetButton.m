...
#define kImageViewW 40
#define kImageViewH 40
...
//        self.imageView.layer.cornerRadius = kImageViewW * 0.5;
    }
    return self;
}
...
- (CGRect)imageRectForContentRect:(CGRect)contentRect{
    CGFloat imageW = kImageViewW;
    CGFloat imageH = kImageViewH;
    CGFloat imageX = (self.frame.size.width - kImageViewW) * 0.5;
    CGFloat imageY = 2;
